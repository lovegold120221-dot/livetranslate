...
/**
 * Languages supported by Gemini Live API for translation.
 * Uses BCP 47 language codes as required by the API.
 * Only includes languages with verified translation support.
 */
