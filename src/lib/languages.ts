...
export const SUPPORTED_LANGUAGES: Language[] = [
  ...
  { code: "crh", name: "Crimean Tatar (Cyrillic)", flag: "🇺🇦" },
  ...
  { code: "kgo", name: "Kituba", flag: "🇨🇩" },
  { code: "ktu", name: "Kokborok", flag: "🇮🇳" },
  ...
  { code: "sat", name: "Santali (Ol Chiki)", flag: "🇮🇳" },
  ...
  { code: "tzm-Tfng", name: "Tamazight (Tifinagh)", flag: "🇲🇦" },
